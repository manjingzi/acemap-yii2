                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            ...
                            <p>
                                <?= isset(Yii::$app->user->identity->username) ? Yii::$app->user->identity->username : Yii::t('app', 'Guest') ?>
                                <small><?= isset(Yii::$app->user->identity->email) ? Yii::$app->user->identity->email : Yii::t('yii', 'Login Required') ?></small>
                            </p>
                        </li>
                        <li class="user-body">
