...
$config['email_register_code'] = [
    ...
    'en' => [
        'subject' => '{site_name_en} email registration verification code',
        'body' => 'Dear User: You are registering with {site_name_en} via email. This verification code {code} is valid within 5 minutes. If the verification code tells others that the account will be stolen, please do not disclose it.'
    ],
];
...
$config['email_register_success'] = [
    ...
    'en' => [
        'subject' => '{site_name_en} registered successfully',
        'body' => 'Dear User {username}: You have successfully registered on the {site_name_en} website and log in using your email address.'
    ],
];
